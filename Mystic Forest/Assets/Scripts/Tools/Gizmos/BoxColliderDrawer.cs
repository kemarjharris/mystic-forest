...
public static class BoxColliderDrawer
{
    public static void DrawBoxCollider(Transform transform, Color gizmoColor, Vector3 center, Vector3 size, Quaternion rotation, float alphaForInsides = 0.3f)
    {
        ...
        Gizmos.matrix = Matrix4x4.TRS(transform.position + center, rotation, transform.localScale);
